  ...
  <a href="savepanier.php">Gérer panier</a>
        ...
        <div class="container">
            ...
            <table>
                ...
                if ($conn) {
                    $req = mysqli_query($conn, "SELECT * FROM fournisseur");
                    ...
                    if ($req) {
                        if(mysqli_num_rows($req) === 0){
                            ...
                            while($row = mysqli_fetch_assoc($req)) {
                                echo "<tr>";
                                echo "<td>".$row['idfour']."</td>";
                                echo "<td>".$row['libellefour']."</td>";
                                echo "<td>".$row['contactfour']."</td>";
                                echo "<td><a href='modifierfournisseur.php?id=".$row['idfour']."'>modifier</a></td>";
                                //echo "<td><a href='modifierfournisseur.php?id=".$row['idfour']."'>supprimer</a></td>";
                                echo "</tr>";
                            }
                        }
                    } else {
