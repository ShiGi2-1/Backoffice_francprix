  ...
  <a href="savepanier.php">Gérer panier</a>
        ...
        <div class="container">
            ...
            <table>
                ...
                if ($conn) {
                    $req = mysqli_query($conn, "SELECT * FROM achat");
                    ...
                    if ($req) {
                        if(mysqli_num_rows($req) === 0){
                            ...
                            while($row = mysqli_fetch_assoc($req)) {
                                ...
                                echo "<td><a href='modifierachat.html?id=".$row['numclt']."'>modifier</a></td>";
                                echo "<td><a href='suppachat.html?id=".$row['numclt']."'>panier</a></td>";
                                echo "</tr>";
                            }
                        }
                    } else {
