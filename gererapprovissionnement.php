  ...
  <a href="savepanier.php">Gérer panier</a>
        ...
        <div class="container">
            ...
            <table>
                ...
                if ($conn) {
                    $req = mysqli_query($conn, "SELECT * FROM fourniture");
                    ...
                    if ($req) {
                        if(mysqli_num_rows($req) === 0){
                            ...
                            while($row = mysqli_fetch_assoc($req)) {
                                ...
                                echo "<td>".$row['Date_four']."</td>";
                                echo "<td>".$row['quantite_four']."</td>";
                                echo "<td><a href='modifierfour.php?id=".$row['idfour']."'>modifier</a></td>";
                                //echo "<td><a href='modifierfour.php?id=".$row['idfour']."'>supprimer</a></td>";
                                echo "</tr>";
                            }
                        }
                    } else {
