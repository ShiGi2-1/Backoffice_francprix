                    ...
                    if ($req) {
                        if(mysqli_num_rows($req) === 0){
                            ...
                            while($row = mysqli_fetch_assoc($req)) {
                                ...
                                echo "<td>".$row['prenomclt']."</td>";
                                echo "<td>".$row['nomclt']."</td>";
                                echo "<td>".$row['contactclt']."</td>";
                       
                                echo "<td><a href='modifierclient.html?id=".$row['numclt']."'>modifier</a></td>";
                                // echo "<td><a href='modifierclient.php?id=".$row['numclt']."'>supprimer</a></td>";
                                echo "</tr>";
                            }
                        }
                    } else {
